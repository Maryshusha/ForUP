...
public class functionsUserController implements Initializable {
    ...
    @FXML
    private TableColumn<getProductsData, String> cart_col_composition;
    ...
    @FXML
    private TableColumn<getProductsData, String> products_col_composition;
    ...
    public void CartShowListData() {
        ...
        cart_col_composition.setCellValueFactory(new PropertyValueFactory<>("productsComposition"));
    ...
    public void ProductsShowListData() {
        ...
        products_col_composition.setCellValueFactory(new PropertyValueFactory<>("productsComposition"));
    ...
    public void switchForm(ActionEvent event){
        ...
        buttonStyles.put(products_btn, "-fx-background-color:  transparent; -fx-border-color:  #D9D2D0; -fx-border-radius: 20;");
        buttonStyles.put(сart_btn, "-fx-background-color:  transparent; -fx-border-color:  #D9D2D0; -fx-border-radius: 20;");
